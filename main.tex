...
\end{column}
	...
	\begin{figure}[h]
		...
		\caption{Test performance on three large-scale LTR datasets and one fully synthetic dataset after training on up to 100M simulated queries. The simulated user behavior follows the position-based model~\cite{Craswell2008Cascade}. Results are averaged over 10 independent experimental runs.}
		\label{fig:results}
	\end{figure}
